...
class Test_URL(BasicTest):
    ...
    def test_Order(self):
        ...
        time.sleep(2)
        textvalue = self.driver.find_element(By.XPATH,
    ...
    def test_Delete_Order(self):
        self.driver.find_element(By.XPATH,"//td[text()='" + pytest.ExpUserName + "']//preceding-sibling::td/input").click()
        time.sleep(2)
        self.driver.find_element(By.NAME, "ctl00$MainContent$btnDelete").click()
        time.sleep(2)
        deltedusername = self.driver.page_source
        #assert deltedusername == False
        # print True if text is present else False
        assert pytest.ExpUserName != deltedusername
        #print(pytest.ExpUserName not in deltedusername)
